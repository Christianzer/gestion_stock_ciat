    ...
    <div class="container-fluid p-3">
        ...
        <div v-else>
            <div id="essaie">
                <div class="invoice-box">
                    <table>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td class="font-weight-bold text-primary">
                                            FACTURE N°: {{informationPaiement.code_facture}}
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr class="total">
                            <td colspan="4"></td>
                            <td style="font-size: 16px" class="text-primary font-weight-bold text-uppercase">Versement : {{new Intl.NumberFormat().format(informationPaiement.montant_verser)}} FCFA</td>
                        </tr>
                        <tr class="total">
                            <td colspan="4"></td>
                            <td style="font-size: 16px" class="text-danger font-weight-bold text-uppercase">Rendu : {{new Intl.NumberFormat().format(informationPaiement.montant_rendu)}} FCFA</td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <div align="right">
                ...
                <b-button variant="primary" @click="imprimer(informationPaiement.code_facture)">
                    IMPRIMER LA FACTURE
                </b-button>
            </div>
        </div>
...
export default {
    ...
    methods : {
        async chargerDonne(code_facture){
            this.Loading = false
            let api_data = 'http://127.0.0.1:8000/api/factures/'+code_facture
