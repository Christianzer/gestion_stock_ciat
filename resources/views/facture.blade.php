...
<main>
    <div id="details" class="clearfix">
        <div id="client">
            <div class="name">FACTURE DE: {{$valeur['factures']->nom}} {{$valeur['factures']->prenoms}}</div>
            <div class="name">CONTACT :{{$valeur['factures']->telephone}}</div>
        </div>
        <div id="invoice">
            <div class="name">FACTURE N° {{$valeur['factures']->code_facture}}</div>
            <div class="name">Date facture: {{$date_jour}}</div>
        </div>
    </div>
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td colspan="2"></td>
            <td colspan="2" style="text-transform: uppercase;">montant versé</td>
            <td>{{number_format($valeur['factures']->montant_verser,'0','.',' ')}} FCFA</td>
        </tr>
        <tr>
            <td colspan="2"></td>
            <td colspan="2" style="text-transform: uppercase;">montant rendu</td>
            <td>{{number_format($valeur['factures']->montant_rendu,'0','.',' ')}} FCFA</td>
        </tr>
        </tfoot>
    </table>
